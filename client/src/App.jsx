...
function SupportChatDrawer() {
  ...
  const options = [
    ...
    { label: '💬 Live WhatsApp Support', action: () => { window.open('https://wa.me/916200708297?text=Hello%20Gaya%20ji%20A%20to%20Z%20Mart%20Support!%20I%20need%20assistance.', '_blank'); } },
      ...
      <div className={`chat-drawer ${isOpen ? 'open' : ''}`}>
        <div className="chat-header">
          <div className="chat-header-info">
            ...
            <div className="chat-header-text">
              <h4>Gaya ji Digital Mart Support Desk</h4>
        ...
        <div className="chat-body">
          <div className="chat-message-bubble">
            👋 Hello! Welcome to Gaya ji Digital Mart Customer Care. We are here to help you.
          </div>
