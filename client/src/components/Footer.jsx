    ...
    return (
        <footer style={{
            ...
            <div className="container" style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                    <h3 style={{ fontSize: '1.6rem', fontWeight: '800', color: '#ffffff', margin: 0 }}>
                        Gaya ji Digital Mart
                    </h3>
                    <p style={{ color: '#a0a0a0', margin: 0, fontSize: '0.9rem', lineHeight: '1.6' }}>
                        Gaya ji Digital Mart is your ultimate general retail platform, offering high-quality home utilities, personal care essentials, fashion, grocery, electronics accessories, and fitness gear.
                    </p>
                    {/* Social Icons */}
                ...
                <div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        <a href={`tel:${socialLinks.phone || '+916200708297'}`} className="footer-contact-link">
                            ...
                            <span>{socialLinks.phone || '+91 6200708297'}</span>
                        </a>
                        <a href={`mailto:${socialLinks.email || 'gayajimartatoz@gmail.com'}`} className="footer-contact-link">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style={{ color: '#ffffff' }}>
                                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                            </svg>
                            <span>{socialLinks.email || 'gayajimartatoz@gmail.com'}</span>
                        </a>
                    </div>
                </div>
            ...
            <div className="container" style={{
                ...
                <div>© 2026 Gaya ji Digital Mart. All rights reserved.</div>
