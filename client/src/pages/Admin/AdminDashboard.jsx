...
const AdminDashboard = () => {
    ...
    const [settings, setSettings] = useState({ facebook: '', instagram: '', phone: '+91 6200708297', email: 'gayajimartatoz@gmail.com' });
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', color: 'var(--text-secondary)', minWidth: '600px' }}>
                            ...
                            <tbody>
                                {users.map(user => {
                                    ...
                                    const isSuperAdmin = ['ishanisharma77289@gmail.com', 'ugantsharma@89', 'bipiye3181@ixospace.com'].includes(user.email.toLowerCase());
                                    return (
