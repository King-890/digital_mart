            ...
            <div className="glass" style={{ padding: '3rem', borderRadius: '16px', background: '#ffffff' }}>
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p style={{ color: 'var(--text-secondary)', lineHeight: '1.8' }}>
                        By accessing and using Gaya ji Digital Mart, you agree to be bound by these Terms and Conditions. If you do not agree, please do not use our website.
                    </p>
                </section>
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p style={{ color: 'var(--text-secondary)', lineHeight: '1.8' }}>
                        You may use Gaya ji Digital Mart for personal and non-commercial purposes only. Any unauthorized use, including data mining or scraping, is strictly prohibited.
                    </p>
                </section>
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p style={{ color: 'var(--text-secondary)', lineHeight: '1.8' }}>
                        Gaya ji Digital Mart shall not be liable for any direct, indirect, incidental, or consequential damages resulting from the use or inability to use our services.
                    </p>
                </section>
