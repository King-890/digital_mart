        ...
        <div className="home-container" style={{ paddingBottom: '4rem' }}>
            ...
            <main className="container" style={{ minHeight: '60vh' }}>
                ...
                <section className="section-card">
                    <h2 style={{ textAlign: 'center', fontSize: '2rem', fontWeight: '900', marginBottom: '2.5rem', letterSpacing: '2px' }}>Gaya ji Digital Mart FEATURED</h2>
