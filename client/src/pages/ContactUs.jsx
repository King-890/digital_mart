...
const ContactUs = () => {
    ...
    const [settings, setSettings] = useState({ phone: '+91 6200708297', email: 'gayajimartatoz@gmail.com' });
            ...
            <div className="glass" style={{ padding: '2rem', borderRadius: '12px', maxWidth: '800px', margin: '0 auto', background: '#ffffff' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        ...
                        <InfoBox icon="📍" title="Visit Us" text="Gaya ji Digital Mart HQ, Gaya, Bihar, India" />
                    </div>
                </div>
            </div>
        </div>
