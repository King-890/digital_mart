# Gaya Ji Mart - Customer Handover Guide

Welcome to your new e-commerce platform, **Gaya Ji Mart**! This document contains all the instructions you need to run, manage, and deploy your website.
...
5.  **Environment Variables**:
    ...
    -   `ADMIN_EMAIL`: Your support email (default: `martfolder@gmail.com`)
6.  **Persistence**:
